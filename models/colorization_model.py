...
class ColorizationModel(Pix2PixModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        Parameters:
            ...
            is_train (bool) -- whether training phase or test phase. You can use this flag to
            add training-specific or test-specific options.

        Returns:
            the modified parser.

        By default, we use 'colorization' dataset for this model.
        See the original pix2pix paper (https://arxiv.org/pdf/1611.07004.pdf) and colorization results
