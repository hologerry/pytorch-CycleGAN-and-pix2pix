...
class TemplateModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        Parameters:
            ...
            is_train -- if it is training phase or test phase.
            You can use this flag to add training-specific or test-specific options.

        Returns:
            the modified parser.
        """
        # You can rewrite default values for this model.
    ...
    def __init__(self, opt):
        ...
        # to plot the losses to the console and save them to the disk.
        self.loss_names = ['loss_G']
        # specify the images you want to save and display.
        # The program will call base_model.get_current_visuals to save and display these images.
